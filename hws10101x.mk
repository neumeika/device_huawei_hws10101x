...
$(call inherit-product-if-exists, vendor/huawei/hws10101x/hws10101x-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/huawei/hws10101x/overlay
...
LOCAL_PATH := device/huawei/hws10101x
...
# Include keyboards
$(call inherit-product-if-exists, device/huawei/hws10101x/keyboards/keyboards.mk)
...
# $(LOCAL_PATH)/configs/audio/hws10101x_audio_config.conf:system/etc/huawei/audio/hws10101x_audio_config.conf \
# $(LOCAL_PATH)/configs/audio/hws10101x_factory_audio_config.conf:system/etc/huawei/audio/hws10101x_factory_audio_config.conf \
...
# Bluetooth 
# Include initscripts
$(call inherit-product-if-exists, device/huawei/hws10101x/initscripts/initscripts.mk)
